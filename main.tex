...
% 目錄語言: \toggletrue = 中文目錄, \togglefalse = 英文目錄 (Contents / List of Figures / List of Tables)
...
\newcommand{\NameofDepartmentInstituteCN}{多媒體工程研究所}
